...
if (configOpsJob == null) {
  ...
  SCMSource scm = new GitSCMSource("https://github.com/ikurtz-cbci-october-workshop/pipeline-template-catalog.git");
      ...
      <instance>
        ...
        <values class="tree-map">
          ...
          <entry>
            ...
            <string>ikurtz-cbci-october-workshop</string>
          </entry>
          <entry>
        ...
        <data>
          <jenkins.branch.BranchSource>
            <source class="org.jenkinsci.plugins.github_branch_source.GitHubSCMSource" plugin="github-branch-source@2.8.3">
              ...
              <repoOwner>ikurtz-cbci-october-workshop</repoOwner>
              <repository>pipeline-template-catalog</repository>
              <repositoryUrl>https://github.com/ikurtz-cbci-october-workshop/pipeline-template-catalog.git</repositoryUrl>
              <traits>
